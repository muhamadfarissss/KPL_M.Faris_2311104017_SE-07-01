class SayaTubeVideo {
  ...
  try {
    const user = new SayaTubeUser("Faris");
  
    const titles = [
      "Review Film Interstellar oleh Faris",
      "Review Film Inception oleh Faris",
      "Review Film Tenet oleh Faris",
      "Review Film The Dark Knight oleh Faris",
      "Review Film Oppenheimer oleh Faris",
      "Review Film Dunkirk oleh Faris",
      "Review Film Prestige oleh Faris",
      "Review Film Memento oleh Faris",
      "Review Film Parasite oleh Faris",
      "Review Film The Matrix oleh Faris"
    ];
